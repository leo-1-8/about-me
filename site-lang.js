(function () {
    ...
    function base() {
        return {
            ...
            warning_updates_in: 'MAJOR UPDATE IN',
    ...
    window.I18N = {
        ...
        fil: Object.assign(base(), {
            ...
            settings_reset_default: 'Ibalik sa Dati',
            settings_reset_btn: 'I-reset',
            settings_theme: 'Tema',
            settings_language: 'Wika',
            settings_volume: 'Lakas ng Tunog',
            ...
            warning_updates_in: 'MAJOR UPDATE SA',
        ...
        id: Object.assign(base(), {
            ...
            warning_updates_in: 'MAJOR UPDATE DALAM',
        ...
        ja: Object.assign(base(), {
            ...
            warning_updates_in: 'メジャーアップデートまで',
